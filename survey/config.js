...
module.exports = {
    projectShortname: `od_demo`,
    projectDirectory: `${__dirname}/runtime`,
    logoPaths: {
        fr: `/dist/images/logo_od_demo_fr.svg`,
        en: `/dist/images/logo_od_demo_en.svg`
    },
    countryCode: 'CA',
    ...
    title: {
        fr: 'Enquête origine-destination: démo',
        en: 'Origin-Destination Survey: Demo'
    },
    defaultLocale: 'fr',
